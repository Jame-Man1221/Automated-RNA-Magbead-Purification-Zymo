...
- Custom Sample Protocol :  RNA purification for any number of samples up to 96, compatible with older Opentrons APIs without partial tip usage in 8 channel pipette.
