...
- Custom Sample Protocol :  RNA purification for any number of samples up to 48 using 8-channel pipette, compatible with the older Opentrons API 2.19 without partial tip commands.
